                  ...
                  child: PageView(
                    ...
                    children: [
                      Stack(
                        children: [
                          ClipRRect(
                            ...
                            child: Image.asset(
                              'assets/images/02_Notification_1.jpg',
                              width: double.infinity,
                              height: double.infinity,
                              fit: BoxFit.cover,
                            ),
                      ...
                      ClipRRect(
                        borderRadius: BorderRadius.circular(8.0),
                        child: Image.asset(
                          'assets/images/03_Notification_2.jpg',
                          width: 300.0,
                          height: 200.0,
                          fit: BoxFit.cover,
                        ),
                        ...
                        child: Stack(
                          children: [
                            ClipRRect(
                              borderRadius: BorderRadius.circular(8.0),
                              child: Image.asset(
                                'assets/images/04_Notification_3.jpg',
                                width: double.infinity,
                                height: double.infinity,
                                fit: BoxFit.cover,
                              ),
                  ...
                  child: Padding(
                    ...
                    child: smooth_page_indicator.SmoothPageIndicator(
                      ...
                      effect: smooth_page_indicator.ExpandingDotsEffect(
                        ...
                        dotWidth: 16.0,
                        dotHeight: 8.0,
                        dotColor: FlutterTheme.of(context).accent1,
                        activeDotColor: FlutterTheme.of(context).primary,
