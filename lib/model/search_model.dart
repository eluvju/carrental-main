class SearchCarModel {
  ...
  SearchCarModel({this.response, this.data, this.message});

  SearchCarModel.fromJson(Map<String, dynamic> json) {
...
class Data {
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    if (json['car_image'] != null) {
      carImage = <CarImage>[];
      if (json['car_image'] is List) {
        json['car_image'].forEach((v) {
          carImage!.add(CarImage.fromJson(v));
        });
      }
    }
